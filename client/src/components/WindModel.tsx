...
function WindyEmbed({ 
  ...
  return (
    <div className="relative w-full h-full overflow-hidden">
      ...
      />
      <div 
        className="absolute top-0 z-10 flex items-center gap-2 px-3 py-2 bg-gradient-to-r from-teal-600 to-teal-500 rounded-b-lg shadow-lg"
        style={{ left: '60px', minWidth: '140px' }}
      >
